      ...
      <div>
        ...
        <div className="container mx-auto p-6">
          ...
          <div className="flex w-full my-3">
            <input type="text" placeholder="Masukkan kata pencarian..." className="rounded-full bg-gray-200 w-full p-2 px-4 border-2 border-transparent text-blue-800 font-semibold focus:text-black focus:border-solid focus:bg-white focus:border-blue-300 focus:shadow sm:focus:shadow-md md:focus:shadow-lg lg:focus:shadow-xl transition duration-300 ease-out" onInput={this.queryHandler.bind(this)}/>
          </div>
          <div className="py-2">
            {
